...
echo Build x86 UWP
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBuild.exe" Oxard.XControls.UWP\Oxard.XControls.UWP.csproj /t:build /p:Configuration=Release /p:Platform="x86"
echo Build x64 UWP

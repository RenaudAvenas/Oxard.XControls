...
{
    /// <summary>
    /// Implement dynamic resource for <see cref="Setter"/>.
    /// </summary>
    public class XFSetterDynamicResource : ExtendedDynamicResourceImplementation<Setter>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public XFSetterDynamicResource(Setter targetObject, Element container, string resourceKey, IProvideValueTarget provideValueTarget)

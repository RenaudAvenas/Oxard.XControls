...
namespace Oxard.Maui.XControls.Components
{
    ...
    public class ItemsControl : ContentView
    {
        ...
        private Layout itemsPanel;

        /// <summary>
        /// Get or set the layout used to display items
        /// </summary>
        public Layout ItemsPanel
        {
            get => this.itemsPanel;
        ...
        protected virtual void OnItemContainerStyleChanged()
        {
            ...
            foreach (var item in ItemsPanel.Children)
                ((VisualElement)item).Style = this.ItemContainerStyle;
        }
        ...
        private void ComputeAlternationIndexForItem(IView item, int index)
        {
            SetAlternationIndex((BindableObject)item, index % this.AlternationCount);
        }
